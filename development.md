...
When you deploy it to production (or staging), it will deploy each service in a different subdomain, like `api.example.com` for the backend, `dashboard.example.com` for the client app, and `admin.example.com` for the admin app.
...
Traefik will use this to transmit traffic at `api.localhost.tiangolo.com` to the backend, `dashboard.localhost.tiangolo.com` to the client app, and `admin.localhost.tiangolo.com` to the admin app.
...
Frontend (client): <http://dashboard.localhost.tiangolo.com>

Frontend (admin): <http://admin.localhost.tiangolo.com>
